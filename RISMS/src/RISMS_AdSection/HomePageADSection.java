...
public class HomePageADSection {

    private JFrame frmRismsHPS;
    private String username;
    private String user_type;
    
    public HomePageADSection(String username, String user_type) {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                HomePageADSection window = new HomePageADSection();
    ...
    public HomePageADSection() {
        initialize();
    }

    private void initialize() {
        frmRismsHPS = new JFrame();
        frmRismsHPS.setTitle("Home Page (Admin Section)");
        ...
        lblRISMSH1.setForeground(Color.WHITE);
        ...
        JLabel lblWELCOMEH1 = new JLabel("Welcome Admin!");
        ...
        frmRismsHPS.getContentPane().add(btnAddProducts);
        ...
        frmRismsHPS.getContentPane().add(btnRepGenerator);
